...
export class UserPageComponent implements OnInit {
  ...
  changeName(): void {
    ...
    this.http.post<User>('https://abdyabdya.duckdns.org:27050/app/update/name', user).subscribe(
      (e) => {
        if (e == null) {
  ...
  changePass(): void {
    ...
    this.http.post<User>('https://abdyabdya.duckdns.org:27050/app/update/password', user).subscribe(
      (e) => {
        if (e == null) {
          alert('ошибка пароль');
        }
