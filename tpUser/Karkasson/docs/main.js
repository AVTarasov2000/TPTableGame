...
class MainPageComponent {
    ...
    ngOnInit() {
        this.http.get('https://abdyabdya.duckdns.org:27050/app/games').subscribe((games) => {
            if (games == null) {
...
class UserPageComponent {
    ...
    changeName() {
        ...
        this.http.post('https://abdyabdya.duckdns.org:27050/app/update/name', user).subscribe((e) => {
            if (e == null) {
                alert('неверный пароль');
            }
            else {
    ...
    changePass() {
        ...
        this.http.post('https://abdyabdya.duckdns.org:27050/app/update/password', user).subscribe((e) => {
            if (e == null) {
                alert('ошибка пароль');
            }
            else {
...
class HistoryPageComponent {
    ...
    ngOnInit() {
        this.http.get('https://abdyabdya.duckdns.org:27050/app/sessions/'
...
class SignInPageComponent {
    ...
    trySignIn(userName, login, password) {
        ...
        this.http.post('https://abdyabdya.duckdns.org:27050/app/login/authentication', user).subscribe((e) => {
            if (e == null) {
                alert('ошибка входа');
            }
            else {
...
class GamesInProgressPageComponent {
    ...
    ngOnInit() {
        ...
        this.http.get('https://abdyabdya.duckdns.org:27050/app/activeSessions/' + id).subscribe((rooms) => {
            if (rooms == null) {
                alert('неверный');
            }
            else {
...
class WaitingRoomPageComponent {
    ...
    onEasyStart() {
        this.http.post('https://abdyabdya.duckdns.org:27050/app/generate/user', { login: this.login }).subscribe((user) => {
    ...
    ngOnDestroy() {
        ...
        if (this.doYouNeedToDeleteYourUserData) {
            ...
            this.http.post('https://abdyabdya.duckdns.org:27050/app/user/delete', user);
...
class GamePageComponent {
    ...
    ngOnInit() {
        ...
        if (!this.game.rules) {
            this.http.post('https://abdyabdya.duckdns.org:27050/app/game', this.game).subscribe((game) => {
                if (game == null) {
                    alert('неверный пароль');
                }
                else {
        ...
        this.http.get('https://abdyabdya.duckdns.org:27050/app/sessions/' + this.crossPageInformation.currentUser.login).subscribe((game) => {
            if (game == null) {
            }
            else {
...
class LoginPageComponent {
    ...
    trySignIn(userName, login, password) {
        if (this.password != this.repeatePassword) {
            ...
            let result = false;
            this.http.post('https://abdyabdya.duckdns.org:27050/app/register', user).subscribe((e) => {
                if (e == null) {
